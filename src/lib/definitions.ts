...
export const CreateProyectoSchema = z.object({
  ...
  coordinadorId: z.number({ required_error: 'El coordinador es obligatorio' }).int().positive(),
  scrumMasterId: z.number({ required_error: 'El Scrum Master es obligatorio' }).int().positive(),
