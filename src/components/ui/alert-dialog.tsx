...
const AlertDialog = ({ onOpenChange, open, ...props }: React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Root>) => {
  React.useEffect(() => {
    if (!open) {
      ...
      // Safety net: Radix AlertDialog sets pointer-events:none on body when modal is open.
      // If cleanup fails, force restoration.
