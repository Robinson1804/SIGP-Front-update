...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { showCloseButton?: boolean; hideOverlay?: boolean }
>(({ className, children, showCloseButton = true, hideOverlay = false, onOpenAutoFocus, onCloseAutoFocus, ...props }, ref) => (
  <DialogPortal>
